 ...
 * If a subclass inherits DataLoggingHandler, it is forced to implement the function log(), and possibly other functions that might be implemented in the future
 ...
 * This allows for an easy implementation and use of additional DataLoggingHandlers, without implying large-scale rewrites where the original DataLoggingHandler was used
 */
